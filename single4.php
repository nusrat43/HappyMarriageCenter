...
<html lang="zxx">
<head>
<title>Elite Match a Matrimonial Category Bootstrap Responsive Website Template  | Single :: W3layouts</title>
<!-- for-mobile-apps -->
...
<div class="matches elite-app">
	...
	<div class="matches-main-agileinfo">
		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
				...
				<li><span>To View His Photo</span> <a href="Register.html">Register Free</a></li>
			</ul>
		</div>
		<div class="clearfix"> </div>
	...
	<div class="col-md-6 person-info-agileits-w3layouts">
			...
			<ul>
				<li><span>Education</span>: Bachelors degree in Marketing</li>
		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			...
			<ul>
				...
				<li><span>No. Of Brothers</span>: 1</li>
				<li><span>No. Of Sisters</span>: Not Specified</li>
			</ul>
		</div>
		<div class="col-md-6 person-info-agileits-w3layouts">
			<h3>What He Is Looking For</h3>
			<ul>
				<li><span>Age</span>: 25-28</li>
				<li><span>Marital Status</span>: Single</li>
				<li><span>Complexion</span>: Fair</li>
				<li><span>height</span>: 5'3'' - 5'5''</li>
