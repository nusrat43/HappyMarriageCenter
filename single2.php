...
<div class="matches elite-app">
	...
	<div class="col-md-6 person-info-agileits-w3layouts">
			...
			<ul>
				<li><span>Education</span>: Engineering</li>
				<li><span>Profession</span>: Team Leader</li>
		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			...
			<ul>
				...
				<li><span>No. Of Brothers</span>: Not Specified</li>
		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			...
			<ul>
				<li><span>Age</span>: 29-32</li>
				<li><span>Marital Status</span>: Single</li>
				<li><span>Complexion</span>: Fair</li>
				<li><span>height</span>: 5'10'' - 6'0''</li>
